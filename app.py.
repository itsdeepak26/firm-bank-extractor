...
st.title("🏦 Universal Bank Statement to Excel")
st.markdown("Upload any bank statement PDF. The system will extract the tables and standardize them into a 6-column Excel format.")
    ...
    if st.button("Extract & Standardize Data"):
        with st.spinner("Processing PDF..."):
            ...
            if final_df is not None:
                ...
                # Convert to Excel memory file for download
                output = BytesIO()
